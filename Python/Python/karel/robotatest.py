...
from karel.robota import javaGraphics
...
#        self.assertRaises(NoBeepers, world.assertBeepersAt(0, 0, 1))
    ...
    class StateCheck(Observer):
        def update(selfself, observable, data): #used just after karel moves
    ...
    def testPickBeeperWhenNonePresent(self):
        ...
        self.assertRaises(NoBeepers, self.karel.pickBeeper)
...
def suite():
    return unittest.makeSuite(robotaTestCase)
