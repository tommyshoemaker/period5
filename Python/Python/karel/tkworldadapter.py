...
from karel.tkworldmaker import WorldMaker

_window = None #KarelWindow(12, 12)
_windowSize = 600 # change this to change the size (in pixels) of the robot world window. 
...
def window():
    global _window, _windowSize
    if _window == None :
        _window = KarelWindow(12, 12, _windowSize, world.speedCallback)
