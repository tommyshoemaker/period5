...
#        World.startThreads() # not public
    ...
    def showBeepers(self):
        for (street, avenue) in list(self._beepers.keys())  :
    ...
    def assertRobotsAt(self, street, avenue):
        ...
        for x in list(self._robots.keys()) :
    ...
    def showWalls(self):
        for (street, avenue) in list(self._eastWestWalls.keys())  :
           print("East-West wall north of corner (" + str(street) + ", " + str(avenue) + ")")
        for (street, avenue) in list(self._northSouthWalls.keys())  :
    ...
    def _neighborsOf(self, robot):
        result = []
        for anyRobot in list(self._robots.keys()) :
    ...
    def saveWorld(self, filename):
        ...
        for  (x,y) in list(self._beepers.keys()) :
            lines.append("beepers " + str(x) + " " + str(y) + " " + str(self._beepers[(x,y)]) + "\n")
        for (x, y) in list(self._eastWestWalls.keys()) :
            lines.append("eastwestwalls " + str(x) + " " + str(y) + " " + str(y) + "\n")
        for (x, y) in list(self._northSouthWalls.keys()):
    ...
    def _clearBefore(self, robot):
        ...
        if direction == karel.robota.North and self._clearNorthOf(street, avenue) :
            return True
        elif direction == karel.robota.East and self._clearEastOf(street, avenue) :
            return True
        elif direction == karel.robota.South and self._clearSouthOf(street, avenue) :
            return True
        elif direction == karel.robota.West and self._clearWestOf(street, avenue) :
            return True
        else :
            return False
